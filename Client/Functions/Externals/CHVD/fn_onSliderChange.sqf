...
_viewDistValue = _sliderPos min CHVD_maxView max 1;
switch (_varType1) do {
	case 'CHVD_foot': {
		_viewDistValue = _sliderPos min CHVD_maxView max 1;
	};
	case 'CHVD_car': {
		_viewDistValue = _sliderPos min CHVD_maxViewVeh max 1;
	};
	case 'CHVD_air': {
		_viewDistValue = _sliderPos min CHVD_maxViewAir max 1;
	};
};
