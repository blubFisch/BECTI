...
ZAM_showNames_group_teams = false; 	// Enable team names for current group
ZAM_showNames_fade  = false; 	// Enable fade of name tag with distance
...
ZAM_showNames_voice = false; 	// Support for TFAR and ACRE
