...
_specials pushBack 		[["DMG_Alternative"], ["DMG_Reduce", 0.39]];
...
_specials pushBack 		[["DMG_Alternative"], ["DMG_Reduce", 0.42]];
_conditions pushBack 	(compile format["(%1) call CTI_CO_FNC_IsHQDeployed", _side]);
...
_specials pushBack 		[["DMG_Alternative"], ["DMG_Reduce", 0.425]];
_conditions pushBack 	(compile format["(%1) call CTI_CO_FNC_IsHQDeployed", _side]);
...
_specials pushBack 		[["DMG_Alternative"], ["DMG_Reduce", 1.685]]; 
_conditions pushBack 	(compile format["(%1) call CTI_CO_FNC_IsHQDeployed", _side]);
...
_times pushBack 		120;
_placements pushBack 	[90, 25];
_specials pushBack 		[["DMG_Alternative"], ["DMG_Reduce", 2.58]];
_conditions pushBack 	(compile format["(%1) call CTI_CO_FNC_IsHQDeployed", _side]);
...
_specials pushBack 		[["DMG_Alternative"], ["DMG_Reduce", 1600]];
_conditions pushBack 	(compile format["(%1) call CTI_CO_FNC_IsHQDeployed", _side]);
...
_times pushBack 		40;
_placements pushBack 	[90, 25];
_specials pushBack 		[["DMG_Alternative"], ["DMG_Reduce", 1.94]];
_conditions pushBack 	(compile format["(%1) call CTI_CO_FNC_IsHQDeployed", _side]);
...
_times pushBack 		35;
_placements pushBack 	[90, 25];
_specials pushBack 		[["DMG_Alternative"], ["DMG_Reduce", 1.83]];
_conditions pushBack 	(compile format["(%1) call CTI_CO_FNC_IsHQDeployed", _side]);
...
_specials pushBack 		[["DMG_Alternative"], ["DMG_Reduce", 0.2]];
_conditions pushBack 	(compile format["(%1) call CTI_CO_FNC_IsHQDeployed", _side]);
...
_times pushBack 		30;
_placements pushBack 	[180, 15];
_specials pushBack 		[["DMG_Alternative"], ["DMG_Reduce", 0.05]];
_conditions pushBack 	(compile format["(%1) call CTI_CO_FNC_IsHQDeployed", _side]);
