...
//--- Infantry
//--- NATO Infantry (Arid)
_c pushBack 'B_Sharpshooter_F';
_p pushBack '';
_n pushBack ["%1 (Sharpshooter Arid)"];
_o pushBack 500;
_t pushBack 5;
_u pushBack 1;
...
//--- NATO FIA (Arid)
_c pushBack 'B_G_Sharpshooter_F';
_p pushBack '';
_n pushBack ["%1 (Sharpshooter FIA)"];
_o pushBack 500;
_t pushBack 5;
_u pushBack 1;
_f pushBack CTI_FACTORY_BARRACKS;
...
//--- NATO Special Forces
_c pushBack 'B_ghillie_lsh_F';
_p pushBack '';
_n pushBack ["%1 (Ghillie Special Forces Lush)"];
_o pushBack 500;
_t pushBack 5;
_u pushBack 1;
_f pushBack CTI_FACTORY_BARRACKS;
...
_c pushBack 'B_ghillie_sard_F';
_p pushBack '';
_n pushBack ["%1 (Ghillie Special Forces Sand)"];
_o pushBack 500;
_t pushBack 5;
_u pushBack 1;
_f pushBack CTI_FACTORY_BARRACKS;
...
_c pushBack 'B_ghillie_ard_F';
_p pushBack '';
_n pushBack ["%1 (Ghillie Special Forces Arid)"];
_o pushBack 500;
_t pushBack 5;
_u pushBack 1;
_f pushBack CTI_FACTORY_BARRACKS;
...
_c pushBack 'B_Recon_Sharpshooter_F';
_p pushBack '';
_n pushBack ["%1 (Sharpshooter Special Forces)"];
_o pushBack 500;
_t pushBack 5;
_u pushBack 1;
_f pushBack CTI_FACTORY_BARRACKS;
