...
if (CTI_IsClient) then {
	missionNamespace setVariable [Format["CTI_%1_UPGRADES_LABELS", _side], [
		...
		["Base Defences", "<t>Unlock better defences structures and weapons<br /><t color='#ffff00'>LVL 1</t> - Basic ZSU and more.<br /><t color='#ffff00'>LVL 2</t> - Unlocks AA/AT, FOB and more.<br /><t color='#ffff00'>LVL 3</t> - Unlocks Large FOB, CRAM and more.<br /><t color='#ffff00'>LVL 4</t> - Unlocks CRAM missle, SAM/PATRIOT and more.   </t>"] //--- Base defense
	]];
};
