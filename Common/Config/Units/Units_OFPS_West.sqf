...
_c pushBack 'OFPS_HUNTER_GMG';
_p pushBack '';
_n pushBack 'Hunter GMG (Pacific)';
_o pushBack 2850;
_t pushBack 10;
_u pushBack 3;
_f pushBack CTI_FACTORY_LIGHT;
...
_c pushBack 'OFPS_HUNTER_HMG';
_p pushBack '';
_n pushBack 'Hunter HMG (Pacific)';
_o pushBack 2150;
_t pushBack 10;
_u pushBack 3;
_f pushBack CTI_FACTORY_LIGHT;
