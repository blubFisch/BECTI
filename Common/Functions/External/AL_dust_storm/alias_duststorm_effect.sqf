...
// [[[],"AL_storm\alias_duststorm_effect.sqf"],"BIS_fnc_execVM",true,false] spawn BIS_fnc_MP;
...
/*	"colorCorrections" ppEffectAdjust[ 0.86, 1, 0.01, [-0.14, 0.17, 0.33, -0.14],[0.86, -0.4, 0.86, 0.86],[-0.57, 0.86, -1.2, 0.86]];
	...
	_leaves_p setParticleCircle [fulg_p_dust_range, [0, 0, 0]]; 
	...
	_alias_local_fog setParticleCircle [fulg_p_dust_radius, [3, 3, 0]];
	_alias_local_fog setParticleRandom [fulg_p_dust_radius, [0.25, 0.25, 0], [1, 1, 0], 1, 1, [0, 0, 0, 0.1], 0, 0];
	_alias_local_fog setParticleParams [["\A3\data_f\cl_basic", 1, 0, 1], "", "Billboard", 1, 12, [0, 0, 0], [-1, -1, 0], 3, 10.15, 7.9, 0.01, [10, 10, 20], [[0.65, 0.5, 0.5, 0], [0.65, 0.6, 0.5, (fulg_p_dust_opacity_multiplier * 0.3)], [1, 0.95, 0.8, 0]], [0.08], 1, 0, "", "", vehicle player];
