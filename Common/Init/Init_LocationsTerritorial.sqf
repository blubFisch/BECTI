...
switch (toLower(worldName)) do {
	case "altis": {
		...
		Kinsella setVariable ["cti_town_neighbors",[CainnaWind,Orellan,AeroportoKinsella,Djolan,Numbo]];
		AeroportoKinsella setVariable ["cti_town_neighbors",[Kinsella,Orellan,RefugeeCamp]];
		Orellan setVariable ["cti_town_neighbors",[Kinsella,AeroportoKinsella,Kingala]];
		Kingala setVariable ["cti_town_neighbors",[Orellan,RefugeeCamp,Larenga]];
		...
		Mawimbela setVariable ["cti_town_neighbors",[Cova,Ursana,Larenga,RefugeeCamp,Numbo,AeroportoTasmera]];
		Numbo setVariable ["cti_town_neighbors",[Kinsella,AeroportoKinsella,RefugeeCamp,Mawimbela,Naromaru]];
		Djolan setVariable ["cti_town_neighbors",[Kinsella,DeBoor,Simbala,Vestinga]];
		DeBoor setVariable ["cti_town_neighbors",[Kinsella,Djolan,Simbala]];
		Simbala setVariable ["cti_town_neighbors",[DeBoor,Djolan,Spookdorp]];
		Katakabi setVariable ["cti_town_neighbors",[Spookdorp,Simbala]];
		Vestinga setVariable ["cti_town_neighbors",[Spookdorp,Djolan,Simbala,Kwako]];
		Spookdorp setVariable ["cti_town_neighbors",[Vestinga,Katakabi,Simbala,Kwako]];
		Kwako setVariable ["cti_town_neighbors",[Spookdorp,Vestinga,AeroportoSwonto,Forteza,Papunya]];
		...
		Tarisol setVariable ["cti_town_neighbors",[Pinley,AshlakeResort,Ravane]];
		...
		Mochiwo setVariable ["cti_town_neighbors",[KalimboArmybase,Polani,Ravane]];
		...
		Mangomak setVariable ["cti_town_neighbors",[KieraYanga,Kaalom,MacHida,Chaba,Xibo]];
		...
		CampBokoro setVariable ["cti_town_neighbors",[Chaba,MacHida]];
		Xibo setVariable ["cti_town_neighbors",[Mangomak,KieraYanga,Casinda,Pumado,Maluri,Zeelor]];
		Zeelor setVariable ["cti_town_neighbors",[Canto,Bobadah,Maluri,Xibo]];
		Canto setVariable ["cti_town_neighbors",[Zeelor,Cova,AeroportoMolatia]];
		AeroportoMolatia setVariable ["cti_town_neighbors",[Canto,Zeelor,Bolabongo,Maluri,Pumado,Bolabongo,Naromaru,Cova]];
		Cova setVariable ["cti_town_neighbors",[Canto,Ursana,Mawimbela,Naromaru,AeroportoMolatia]];
		Maluri setVariable ["cti_town_neighbors",[Pumado,Casinda,Xibo,Bobadah,AeroportoMolatia]];
		Pumado setVariable ["cti_town_neighbors",[AeroportoMolatia,Bolabongo,Engor,Casinda,Xibo,Maluri]];
		Casinda setVariable ["cti_town_neighbors",[Pumado,Engor,Xibo,Maluri]];
	...
	case "malden": {
		...
		ComPlatform setVariable ["cti_town_neighbors",[Moray,Lolisse]];
		...
		SaintJean setVariable ["cti_town_neighbors",[MountChauve,PicDeFleas,Goisse]];
		Goisse setVariable ["cti_town_neighbors",[ComPlatform,SaintJean,WindFarm]];
		Arudy setVariable ["cti_town_neighbors",[PicDeFleas,Dourdan]];
		PicDeFleas setVariable ["cti_town_neighbors",[SaintJean,Arudy,LaPessagne]];
		LaPessagne setVariable ["cti_town_neighbors",[PicDeFleas,Carton,Arette]];
	...
	case "napf": {
		...
		Brienz setVariable ["cti_town_neighbors",[Goldwil,WindFarm,Froburg,Sorenberg,Goldwil]];
