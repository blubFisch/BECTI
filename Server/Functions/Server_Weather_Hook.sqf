...
if (CTI_WEATHER_OVERCAST_COEF == 0) then {_rain_variance_coef_setting = 1};
if (CTI_WEATHER_OVERCAST_COEF > 0) then {_rain_variance_coef_setting = CTI_WEATHER_OVERCAST_COEF};
if (CTI_WEATHER_FOG == -1) then { _fog_setting = random 1 };
if (CTI_WEATHER_FOG >= 0) then { _fog_setting = CTI_WEATHER_FOG / 100 };
if (CTI_WEATHER_FOG_COEF == 0) then {_rain_variance_coef_setting = 1};
if (CTI_WEATHER_FOG_COEF > 0) then {_rain_variance_coef_setting = CTI_WEATHER_FOG_COEF};
...
if (CTI_WEATHER_FOG_DECAY_COEF == 0) then {_rain_variance_coef_setting = 1};
if (CTI_WEATHER_FOG_DECAY_COEF > 0) then {_rain_variance_coef_setting = CTI_WEATHER_FOG_DECAY_COEF};
...
if (CTI_WEATHER_FOG_ALT_COEF == 0) then {_rain_variance_coef_setting = 1};
if (CTI_WEATHER_FOG_ALT_COEF > 0) then {_rain_variance_coef_setting = CTI_WEATHER_FOG_ALT_COEF};
if (CTI_WEATHER_WIND == -1) then { _wind_setting = random 10 };
if (CTI_WEATHER_WIND >= 0) then { _wind_setting = CTI_WEATHER_WIND / 10 };
if (CTI_WEATHER_WIND_COEF == 0) then {_rain_variance_coef_setting = 1};
if (CTI_WEATHER_WIND_COEF > 0) then {_rain_variance_coef_setting = CTI_WEATHER_WIND_COEF};
if (CTI_WEATHER_WAVES == -1) then { _waves_setting = random 1 };
if (CTI_WEATHER_WAVES >= 0) then { _waves_setting = CTI_WEATHER_WAVES / 100 };
if (CTI_WEATHER_WAVES_COEF == 0) then {_rain_variance_coef_setting = 1};
if (CTI_WEATHER_WAVES_COEF > 0) then {_rain_variance_coef_setting = CTI_WEATHER_WAVES_COEF};
