...
_object = createSimpleObject ["Land_i_Barracks_V2_F", _pos, [], 0, "CAN_COLLIDE"];
_object setDir 325;
...
_object = createSimpleObject ["Land_Mil_WiredFence_Gate_F", _pos, [], 0, "CAN_COLLIDE"];
...
_object = createSimpleObject ["BlockConcrete_F", _pos, [], 0, "CAN_COLLIDE"];
...
_object = createSimpleObject ["Land_Castle_01_wall_03_F", _pos, [], 0, "CAN_COLLIDE"];
_object setDir 310;
_object setPosATL _pos;
_object enableSimulationGlobal false;

_pos = [17655.625,17274.517578,-1.29478];
_object = createSimpleObject ["Land_Castle_01_wall_04_F", _pos, [], 0, "CAN_COLLIDE"];
_object setDir 50;
_object setPosATL _pos;
_object enableSimulationGlobal false;

_pos = [17644.546875,17239.220703,-2.55485];
_object = createSimpleObject ["Land_Castle_01_wall_14_F", _pos, [], 0, "CAN_COLLIDE"];
_object setDir 0;
_object setPosATL _pos;
_object enableSimulationGlobal false;

_pos = [17638.0878906,17199.699219,-1.90575];
_object = createSimpleObject ["Land_Castle_01_wall_08_F", _pos, [], 0, "CAN_COLLIDE"];
_object setDir 180;
_object setPosATL _pos;
_object enableSimulationGlobal false;
...
_object = createSimpleObject ["Land_Castle_01_wall_13_F", _pos, [], 0, "CAN_COLLIDE"];
_object setDir 140;
_object setPosATL _pos;
_object enableSimulationGlobal false;
...
_object = createSimpleObject ["Land_Castle_01_church_a_ruin_F", _pos, [], 0, "CAN_COLLIDE"];
_object setDir 181;
_object setPosATL _pos;
_object enableSimulationGlobal false;

_pos = [17622,17222.509766,-0.0937119];
_object = createSimpleObject ["Land_Castle_01_tower_F", _pos, [], 0, "CAN_COLLIDE"];
_object setDir 89.9999;
_object setPosATL _pos;
_object enableSimulationGlobal false;

_pos = [17629.623047,17204.976563,-2.1951];
_object = createSimpleObject ["Land_Castle_01_house_ruin_F", _pos, [], 0, "CAN_COLLIDE"];
...
_object = createSimpleObject ["Land_Castle_01_step_F", _pos, [], 0, "CAN_COLLIDE"];
